...
public class UsuarioJpaController implements Serializable {
    ...
    public Usuario findUsuario(String login, String senha) {
        EntityManager em = getEntityManager();
        try {
            // Cria uma consulta JPA (JPQL) para buscar um usuário com o login e senha fornecidos.
            ...
            // Executa a consulta e retorna o resultado único.
                // Se nenhum resultado for encontrado, uma exceção NoResultException será lançada.
